% gz-plugin(SECTION) | User Commands
%
% "March  7 2023"
...
gz-plugin - program to do something

# SYNOPSIS

**gz-plugin** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**gz-plugin** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **gz-plugin** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**gz-plugin** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    gz-plugin. See **foo.conf**(5) for further details.
...
**gz-plugin** provides some return codes, that can be used in scripts:
